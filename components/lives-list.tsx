...
const lives: Live[] = [
  {
    id: "lM7MJIFqVGs",
    title: "Práticas Educ. Inclusivas: Estratégias para a Comunicação, Educação de Surdos e Ensino Natural",
    date: "03/11/2025",
    views: "1,9 mil",
  ...
  {
    id: "JhdmX3tfpjU",
    title: "Congresso Multidisciplinar de Educação: da Neurodiversidade às Inteligências Artificiais",
    date: "01/09/2025",
    views: "2,8 mil",
  ...
  {
    id: "EV2OtdNv_VY",
    title: "Workshop sobre Neurociência, DV e Alfabetização significativa: (re)descobrindo possibilidades",
    date: "01/08/2025",
    views: "2,3 mil",
  ...
  {
    id: "_NMXP6RCg4U",
    title: 'Encontro Nacional - "Diálogos sobre Inclusão"',
    date: "01/07/2025",
    views: "4 mil",
  ...
  {
    id: "TAM4eGo2CPc",
    title: "Congresso Inovar na Educação: Currículos Acessíveis, Planej. Ped. e Avaliação Neuropsicopedagógica",
    date: "02/06/2025",
    views: "2,2 mil",
  ...
  {
    id: "mOYXHfEzu9k",
    title: "Simpósio Práticas Educativas Inclusiva: AH/superdotação, ABA e competências socioemocionais",
    date: "01/05/2025",
    views: "3,2 mil",
