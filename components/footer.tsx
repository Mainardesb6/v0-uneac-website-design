    ...
    <footer className="bg-muted/30 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Avenida Getúlio Vargas, 785 - Centro, Jacarezinho - PR
              </p>
            </div>
            <p className="text-xs text-muted-foreground">CNPJ: 19.993.130/0001-09</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-muted-foreground">WhatsApp: (43) 99643-0458</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-primary" />
                <span className="text-sm text-muted-foreground">cursosjacarezinho@gmail.com</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <Link href="/nossa-equipe" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                Nossa Equipe
              </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <Link
                href="https://www.facebook.com/p/Cursos-UNEAC-100057184131567/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="Facebook"
              ...
              <Link
                href="https://www.youtube.com/channel/UCeuG7xAJmEFRFFCegvqkgnw/videos"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="YouTube"
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Siga-nos nas redes sociais para ficar por dentro das novidades e cursos gratuitos!
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t text-center">
          <p className="text-sm text-muted-foreground">© 2025 Cursos UNEAC. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
