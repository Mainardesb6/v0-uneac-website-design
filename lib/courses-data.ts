...
A partir das perspectivas de ampliação do estudo de povos africanos pelo currículo escolar, este curso proporciona um melhor entendimento da diversidade do continente, e diferentes formas de divisão do seu povo.`,
  ...
  },
  {
    ...
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/project-elaboration-masters-doctorate.jpg",
  ...
  },
  {
    ...
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/bilingual-education-deaf-municipality.jpg",
  ...
  },
  {
    id: 56,
    title:
      "Transtorno de Déficit de Atenção com Hiperatividade (TDAH): manejos contextualizados a partir da Análise Comportamental (ABA) na escola e na clínica",
    category: "Educação Especial",
    duration: "40-100 horas",
    modality: "Online",
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/tdah-aba-school-clinic.jpg",
  ...
  {
    id: 57,
    title: "O funcionamento do cérebro AUTISTA: estratégias e intervenções",
    category: "Educação Especial",
    duration: "40-100 horas",
    modality: "Online",
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/autistic-brain-functioning-strategies.jpg",
  ...
  {
    id: 58,
    title: "Célestin FREINET: da compreensão do desenvolvimento infantil ao registro escrito das crianças",
    category: "Educação",
    duration: "40-100 horas",
    modality: "Online",
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/freinet-child-development-written-record.jpg",
  ...
  {
    id: 59,
    title: "Da avaliação da aprendizagem às Estratégias e Intervenções metodológicas em sala de aula",
    category: "Educação",
    duration: "40-100 horas",
    modality: "Online",
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/learning-assessment-methodological-strategies.jpg",
  ...
  {
    id: 60,
    title: "Atendimento Escolar Hospitalar: princípios, diretrizes e atuação",
    category: "Educação Especial",
    duration: "40-100 horas",
    modality: "Online",
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/hospital-school-care-principles.jpg",
  ...
  {
    id: 61,
    title: "COORDENAÇÃO PEDAGÓGICA NA ESCOLA DA INFÂNCIA: demandas, atuação e o dia a dia de um coordenador na prática",
    category: "Educação",
    duration: "40-100 horas",
    modality: "Online",
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/pedagogical-coordination-early-childhood.jpg",
  ...
  },
  {
    id: 62,
    title:
      "Como ensinar a matemática para crianças com Transtorno do Espectro do Autismo por meio da análise do comportamento aplicada?",
    category: "Educação Especial",
    duration: "40-100 horas",
    modality: "Online",
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/teaching-math-autism-aba.jpg",
  ...
  },
  {
    id: 63,
    title:
      "Como tornar um Currículo Acessível para os Estudantes com Deficiência? Aprendendo os principais Recursos e Estratégias na área da Educação Especial",
    category: "Educação Especial",
    duration: "40-100 horas",
    modality: "Online",
    price: "A partir de R$ 95,00",
    totalPrice: "R$ 95,00 - R$ 185,00",
    image: "/accessible-curriculum-disability-students.jpg",
